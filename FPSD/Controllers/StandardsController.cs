...
namespace FPSD.Controllers
{
    public class StandardsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StandardsID,StandardsType,StandardsName,StandardsDescription")] Standard standard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StandardsID,StandardsType,StandardsName,StandardsDescription")] Standard standard)
        {
            if (ModelState.IsValid)
            {
