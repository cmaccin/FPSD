...
namespace FPSD.Controllers
{
    public class SportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SportsID,SportsType,SportsName")] Sport sport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SportsID,SportsType,SportsName")] Sport sport)
        {
            if (ModelState.IsValid)
            {
